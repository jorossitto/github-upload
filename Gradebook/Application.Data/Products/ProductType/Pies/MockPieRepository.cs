...
namespace Application.Data
{
    public class MockPieRepository : IPieRepository
    {
        ...
        private string mockLongDesc = "Icing carrot cake jelly-o cheesecake. Sweet roll marzipan marshmallow " +
                    "toffee brownie brownie candy tootsie roll. Chocolate cake gingerbread tootsie roll " +
                    "oat cake pie chocolate bar cookie dragée brownie. Lollipop cotton candy cake bear " +
                    "claw oat cake. Dragée candy canes dessert tart. Marzipan dragée gummies lollipop " +
                    "jujubes chocolate bar candy canes. Icing gingerbread chupa chups cotton candy " +
                    "cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit danish chocolate " +
                    "cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake dragée " +
                    "croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake " +
                    "carrot cake liquorice sugar plum topping bonbon pie muffin jujubes. Jelly pastry " +
                    "wafer tart caramels bear claw. Tiramisu tart pie cake danish lemon drops. Brownie " +
                    "cupcake dragée gummies.";

        public IEnumerable<Pie> AllPies =>
            new List<Pie>
            {
                new Pie {PieId = 1, Name="Strawberry Pie", Price=15.95M, ShortDescription="Lorem Ipsum", 
                    LongDescription=mockLongDesc, Category = _categoryRepository.AllCategories.ToList()[0],
